    ...
    class Time_Tracker_Activator_Pages {
        ...
        public static function create_subpage_details_array($id) {
            ...
            $details = array(
				...
				"Content" => "<div class=\"tt-accordion\">Search</div><div class=\"tt-accordion-panel\">" . self::get_form_shortcode("Filter Time") . "</div><h3>Time Details</h3>[tt_time_log_table type=\'detail\']",
                "Paginate" => array(
					"Flag" => true,
					"RecordsPerPage" => 100,
					"PreviousText" => '« Newer',
