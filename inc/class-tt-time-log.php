    ...
    class Time_Log
    {
        ...
        private function get_all_data_for_display() {
            ...
            foreach ($time_entries as $item) {
                ...
                $edit_task_button = "<button onclick='location.href=\"" . TT_HOME . "edit-task/?task-id=" . esc_attr($item->TaskID) . "\"' id=\"edit-task-" . esc_attr($item->TaskID) . "'\" class=\"open-task-edit-page tt-button tt-table-button\">Edit</button>";
                $item->TaskID = [
                    "value" => $item->TaskID,
                    "button" => [
